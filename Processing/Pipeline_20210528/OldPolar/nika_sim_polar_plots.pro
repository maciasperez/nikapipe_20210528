...
pro nika_sim_polar_plots, param, kidpar, data, ps, data_in, test_toi, postscript=postscript, png=png, transp=transp
...
for lambda=1, 2 do begin
   ...
   if nwkids ne 0 then begin
      ...
      ;; Detector timeline
      nika_power_spec, /base, taper=taper, data.rf_didq[ikid],           ps.gen.nu_sampling, pw_toi
      nika_power_spec, taper=taper, (data.rf_didq[ikid]-my_baseline(data.rf_didq[ikid]))*cos4omega, ps.gen.nu_sampling, pw_toi_q
      ...
      ;; Projected timelines
      if strupcase(param.polar.map_method) eq "LOCKIN" then begin
