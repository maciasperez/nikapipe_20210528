...
;; Diagnostic plots
nika_sim_polar_plots, param, kidpar, data, ps, data_in, test_toi
print, ""
print, "HERE"
stop
;; Project maps
...
;; Lock-in maps
param.polar.map_method = "lockin"
nika_pipe_polar_maps, param, data, kidpar, $
                      maps_S0, maps_S1, maps_S2, maps_covar, nhits_coadd, $
                      xmap=xmap_out, ymap=ymap_out
