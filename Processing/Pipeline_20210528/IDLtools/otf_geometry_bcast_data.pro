...
pro otf_geometry_bcast_data, scan, beam_map_subindex, kidpar, $
...
;;    print, "otf_geometry_bcast_data, scan, file_list, $"
...
;; otf_geometry_sub here. It's slower but better for
;; now... (Oct. 29th)
if keyword_set(kids_out) then begin
