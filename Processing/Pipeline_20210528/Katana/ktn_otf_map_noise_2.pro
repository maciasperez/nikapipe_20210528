...
PRO ktn_otf_map_noise_2, toi_ori, show_map=show_map
  common ktn_common
...
nk_get_kid_pointing, param1, info1, data, kidpar
nk_apply_calib, param1, info1, data, kidpar
nk_deglitch_fast, param1, info1, data, kidpar
nk_get_ipix, data, info1, grid_tot
nk_w8, param1, info1, data, kidpar
nk_projection_3, param1, info1, data, kidpar, grid_tot
...
if max(grid_tot.map_var_i_2mm) gt 0 then begin
   map     = grid_tot.map_i_2mm
   map_var = grid_tot.map_var_i_2mm
   nhits   = grid_tot.nhits_2mm
endif
xx = grid_tot.xmap[*,0]
yy = grid_tot.ymap[0,*]
...
nk_mask_source, param1, info1, data, kidpar, grid_tot
index = dindgen( n_elements(data))
nsn = n_elements(data)
;; ;; Why do I interpolate here ?!
...
;; Fill kidpar with noise params and perform a better decorrelation using the
;; mask
data.toi = toi_ori
ktn_noise_estim
...
;;nk_deglitch, param1, info1, data, kidpar
nk_apply_calib, param1, info1, data, kidpar
nk_clean_data, param1, info1, data, kidpar, out_temp_data=out_temp_data
