...
version = 'v1.1'                                     ;Version of the analysis
...
avoid_list = ['20141113s209', '20141113s210', '20141113s211', $
              '20141113s212', '20141113s213', $ ; mostly saturated
             '20141115s275']                  ; pb in nika_pipe_onsource
...
nika_pipe_launch, param, map_combi, map_list, $
                  use_noise_from_map=1, $
                  check_flag_cor=1, check_flag_speed=1, $
                  meas_atm=1, plot_decor_toi=1, ps=1, clean=0, $
                  noskydip=1, multi=1
