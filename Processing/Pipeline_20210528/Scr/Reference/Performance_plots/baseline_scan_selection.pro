pro baseline_scan_selection, info_all, index, selected_scan_list = selected_scan_list, $
                             ...
                             test_planet_fwhm_max=test_planet_fwhm_max
  ...
  if keyword_set(to_use_photocorr) then begin
     ...
     fwhm_max         = [12.0, 17.9, 12.0]
     fwhm_min = [10.0, 16.0, 10.0]
     ;; observation date cut
     daytime_range  = ['15:00', '20:00']  ;; to be discarded
     ;; opacity cut
     tau3max    = 0.5 ;;0.7
     obstau3max = 0.7 ;;1.1
     elevation_min = 0.0d0
...
;;   FWHM selection cut
     ...
     ;;planet_fwhm_max  = [13.0, 18.3, 13.0]
     ;;planet_fwhm_max  = [20.0, 20.0, 20.0]
     planet_fwhm_max  = [12.5, 18.0, 12.5]
     fwhm_max         = [20.0, 20.0, 20.0] ;; in general, FWHMs cannot be measured
...
;;______________________________________________________________________________________________
  ...
  if keyword_set(test_planet_fwhm_max) then planet_fwhm_max=test_planet_fwhm_max 
  ...
  wtokeep = where( info_all.result_fwhm_1 le tab_fwhm_max(0, *) and $
                   ...
                   info_all.result_tau_3 le tau3max and $
                   info_all.result_tau_3/sin(info_all.result_elevation_deg*!dtor) le obstau3max and $
  ...
  tauok_index = where(info_all.result_tau_3 le tau3max and $
                      info_all.result_tau_3/sin(info_all.result_elevation_deg*!dtor) le obstau3max,$
