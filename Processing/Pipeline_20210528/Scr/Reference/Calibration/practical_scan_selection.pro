...
;
;  --> no selection based on the observation date in case the
;  calibrators are visible only during the afternoons
;
;  LP, March 2020
;-
pro practical_scan_selection, info_all, index, selected_scan_list = selected_scan_list, $
...
;;   FWHM selection cut
     ...
     if keyword_set(planet_fwhm_max) then planet_fwhm_max = planet_fwhm_max else $
        planet_fwhm_max  = [12.0, 17.9, 12.0]
