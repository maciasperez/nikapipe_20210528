...
pro log_iram_tel_n2r41
  
spawn, "ls "+!nika.imb_fits_dir+"/*202002*imb.fits", imb_fits_list_feb
spawn, "ls "+!nika.imb_fits_dir+"/*202003*imb.fits", imb_fits_list_march
imb_fits_list = [imb_fits_list_feb, imb_fits_list_march]
...
w = where( long(day_list) ge 20200225 and long(day_list) le 20200303, nw)
...
nonika = 1
run_logfile_save = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_N2R41_v0.save"
run_logfile_csv  = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_N2R41_v0.csv"
...
param_file_list = 'log_iram_tel_N2R41_param_'+strtrim( indgen(nproc),2)+'.save'
