...
pro log_iram_tel_n2r15


run = 'N2R15'
  
spawn, "ls "+!nika.imb_fits_dir+"/*201802*imb.fits", imb_fits_list

nonika = 1
logfile_save_final = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_"+run+"_v0.save"
logfile_csv_final  = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_"+run+"_v0.csv"

;; nonika = 0
;; logfile_save_final = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_"+run+"_v1.save"
;; logfile_csv_final  = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_"+run+"_v1.csv"

run_logfile_save = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_"+run+"_v0.save"
run_logfile_csv  = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_"+run+"_v0.csv"
...
param_file_list = 'log_iram_tel_'+run+'_param_'+strtrim( indgen(nproc),2)+'.save'
...
for iproc=0, nproc-1 do begin
   ...
   endelse
   logfile_save = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_"+run+"_v0_sub"+strtrim(iproc,2)+".save"
   logfile_csv  = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_"+run+"_v0_sub"+strtrim(iproc,2)+".csv"
