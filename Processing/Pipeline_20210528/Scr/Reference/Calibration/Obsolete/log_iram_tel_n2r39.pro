...
pro log_iram_tel_n2r39
  
spawn, "ls "+!nika.imb_fits_dir+"/*202001*imb.fits", imb_fits_list
...
w = where( long(day_list) ge 20200114 and long(day_list) le 20200121, nw)
...
nonika = 1
run_logfile_save = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_N2R39_v0.save"
run_logfile_csv  = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_N2R39_v0.csv"
...
param_file_list = 'log_iram_tel_N2R39_param_'+strtrim( indgen(nproc),2)+'.save'
