...
pro baseline_calibration_v2_NP
...
;;_______________________________________________________________________________________________
     ...
     if do_absolute_calibration gt 0 then begin
        ...
        ;;skydip_kidpar_file =
        ;;getenv('HOME')+'/NIKA/Plots/'+runname+'/Opacity/kidpar_C0C1_'+runname+opa_version_name+'.fits'
        ;; for NP test
        ;;skydip_kidpar_file =
        ;;'/home/ponthieu/NIKA/Plots/'+runname+'/Opacity/kidpar_C0C1_'+runname+'_ref_baseline.fits'
        skydip_kidpar_file = '/home/ponthieu/NIKA/Plots/'+runname+'/Opacity/kidpar_C0C1_'+runname+'_ref_v0.fits'       
...
;; photometric correction
        ...
        output_allinfo_file = 'Uranus_allinfo_'+runname+'_'+test_nickname+'.save'
...
;; parameter copy here
        ...
        case strlowcase(opacity_selection_tab[irun]) of
           ...
           'hightau2': begin
              ...
              if strlowcase(runname) eq 'n2r9' then opa_version_name = opa_version_name+'_hightau2_v3'
              if strlowcase(runname) eq 'n2r12' then opa_version_name = opa_version_name+'_hightau2_v2'
           end
           else: print, 'non recognised opacity selection for run ', runname
        endcase
...
;;-----------------------------
        ...
        output_allinfo_file = 'MWC349_allinfo_'+runname+'_'+test_nickname+'.save'
        ;;output_allinfo_file = 'CRL2688_allinfo_'+runname+'_baseline_v2.save'
        ;;output_allinfo_file = 'NGC7027_allinfo_'+runname+'_baseline_v2.save'
