pro script_180_14_m2_minus_9, nscans=nscans, list_results_only=list_results_only, keep_current_result=keep_current_result, $
subtract_maps=subtract_maps, preproc=preproc, average=average, reset=reset
if keyword_set(average) then begin
rfile = !nika.plot_dir+'/running_180_14_m2_minus_9.dat'
...
nscans = 0 ; init
restore, db_file
w = where( strupcase( strtrim(scan.object,2))  eq strupcase('M2-9') and $
...
if nw eq 0 then begin
   message, /info, 'No scan observing M2-9 was found in '+db_file
   goto, exit
endif
