pro script_180_14_mars, nscans=nscans
...
nscans = 0 ; init
restore, db_file
w = where( strupcase( strtrim(scan.object,2))  eq strupcase('MARS') and $
...
if nw eq 0 then begin
   message, /info, 'No scan observing MARS was found in '+db_file
   goto, exit
endif
