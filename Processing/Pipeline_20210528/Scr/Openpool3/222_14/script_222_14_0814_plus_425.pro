pro script_222_14_0814_plus_425, nscans=nscans, list_results_only=list_results_only, keep_current_result=keep_current_result, $
subtract_maps=subtract_maps, preproc=preproc, average=average, reset=reset
if keyword_set(average) then begin
rfile = !nika.plot_dir+'/running_222_14_0814_plus_425.dat'
...
nscans = 0 ; init
restore, db_file
w = where( strupcase( strtrim(scan.object,2))  eq strupcase('0814+425') and $
...
if nw eq 0 then begin
   message, /info, 'No scan observing 0814+425 was found in '+db_file
   goto, exit
endif
...
param.source        = '0814+425'
param.silent            = 1
param.map_reso          = 2.d0 ; arcsec
param.name4file = '0814+425'
