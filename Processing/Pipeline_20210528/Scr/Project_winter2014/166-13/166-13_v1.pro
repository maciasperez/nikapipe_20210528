...
scan_num4 = [211,212,213,214,215,216,217,218,219,220,221,222,223,224,225,226,228,229,230]
scan_num5 = [234,236,237,238,239,240]
scan_num = [scan_num1, scan_num2, scan_num3, scan_num4, scan_num5]
day = ['20140219'+strarr(n_elements(scan_num1)), $
       '20140220'+strarr(n_elements(scan_num2)), $
       '20140225'+strarr(n_elements(scan_num3)),$
       '20140226'+strarr(n_elements(scan_num4)),$
       '20140226'+strarr(n_elements(scan_num5))]
...
param.coord_pointing = map_coord

param.map.reso = 5
param.map.size_ra = 1200
param.map.size_dec = 1200
...
;;------- Launch the pipeline
nika_pipe_launch, param, map_combi, map_list, /ps, /make_log, /meas_atm, /check_flag_speed, /check_flag_cor,/plot_decor, /silent
...
nika_pipe_launch, param, map_combi, map_list, /ps, /make_log, /meas_atm, /check_flag_speed, /check_flag_cor, /use_noise_from_map, /silent ;,/make_products
...
anapar.time_map.relob.a = 0
anapar.time_map.relob.b = 0
anapar.snr_map.range1mm = [-10,50]
anapar.snr_map.range2mm = [-10,50]
anapar.snr_map.conts1mm = dindgen(10)*6
anapar.snr_map.conts2mm = dindgen(10)*6
