;+
;PURPOSE: Transform acquisition flags into pipeline flags to avoid confusion
;
;; Feb. 7th, 2014 DEFINITION OF FLAGS !!!
...
;INPUT: param, data
;
;OUTPUT: modify pipeflags
;
;LAST EDITION: 
;   2014: Creation (nicolas.ponthieu@obs.ujf-grenoble.fr & macias@lpsc.in2p3.fr)

;-

pro nika_pipe_acqflag2pipeflag, param, data, kidpar
