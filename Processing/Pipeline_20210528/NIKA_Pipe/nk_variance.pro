;$Id: //depot/Release/ENVI50_IDL82/idl/idldir/lib/variance.pro#1 $
;
...
;-
FUNCTION nk_variance, X, DIMENSION=dim, DOUBLE = Double, NAN = NaN

  compile_opt idl2, hidden
  ON_ERROR, 2

  void = NK_MOMENT( X, DIMENSION=dim, Double=Double, $
