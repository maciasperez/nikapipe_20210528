...
pro nk_skydip_3, scan_num, day, kidpar, param=param, sav=sav, help=help, test=test, png=png, ps=ps, RF=RF, $
...
;      estimate=[1790.5466,0.050000001,-1.8193226e+09]
      if channel eq 1 then parinfo[0].limits=[800.,2600.] ;CAMBIATO DA 2500 a 4500!!!
      if channel eq 2 then parinfo[0].limits=[300.,1500.];CAMBIATO DA 1500 a 3500!!! 
      parinfo[1].limits=[0.0,0.6]
...
;         plot, air_mass, 1.d5*(ffrx - fittt) / (fittt), /xst, /yst, /nodata
...
;                                                                                  
   if channel eq 1 then  begin 
      ...
      skydip_res1mm={fit1mm:fit_func, am1mm:air_mass , ft1mm:ft , dft1mm:dft ,idx1mm:idx2 , tau1mm:tau_v}
   endif
; 
   if channel eq 2 then begin
      skydip_final2={channel:tit ,scan_number:scan_num , day:day , valid_kid:flagkid(idx1(idx2)) , par1:fi , par2:ki , par3:tau_fix}
      skydip_res2mm={fit2mm:fit_func, am2mm:air_mass , ft2mm:ft , dft2mm:dft ,idx2mm:idx2 , tau2mm:tau_v}
   endif
;stop
endfor                                                                                 
;stop
