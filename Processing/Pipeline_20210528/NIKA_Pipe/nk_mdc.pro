...
for iarray=1, 3 do begin
   ...
   if nw1 ne 0 then begin
      ...
      if param.improve_atm eq 1 then begin
         residual = toi[w1,*]
      endif else begin
      ...
      ;; Ready to reject KIDs that are too close to one another for
      ;; the decorrelation
      ...
      for i=0, nw1-1 do begin
         ...
         if nblock ge 2 then begin
            ...
            if status eq 0 then begin
               ...
               toi_out[w1[i],*] = reform(residual[i,*])
               out_temp[w1[i],*] += fit[0] + fit[1]*cm
            endif else begin
