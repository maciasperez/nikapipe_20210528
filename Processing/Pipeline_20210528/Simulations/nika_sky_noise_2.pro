...
pro nika_sky_noise_2, t, deltax, deltay, cloud_vx, cloud_vy, alpha_atm, sx, sky_noise_toi, $
                      seed=seed, disk_convolve=disk_convolve


nbol      = n_elements(deltax)
ntime     = n_elements(t)
tmax      = max(t)
...
sky_noise_toi = dblarr(nbol,ntime)
...
simu_atm_map, nx, ny, alpha_atm, seed, map, rdisk_convolve = rdisk_convolve
