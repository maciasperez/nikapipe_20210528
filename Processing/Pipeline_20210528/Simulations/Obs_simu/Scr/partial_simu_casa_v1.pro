...
source = 'Simulation of Cassiopeia A'                         ;Name of the source
...
param.caract_source.mapfile = !nika.save_dir+'/Cassiopeia_A/astrometry_Cassiopeia_A_v1.fits'
...
param.decor.common_mode.flag_lim = [0.3,0.01]
nika_pipe_launch, param, map_combi, map_list, /simu, /save
...
ploterror, prof_a.r, prof_a.y, sqrt(err), $
           ...
           xtitle='radius (arcsec)', ytitle='Flux',$
           psym=1,/nodata
