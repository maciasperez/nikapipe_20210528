...
source = 'Simulation - cluster compact'
version = 'v1'
...
elec = {f_ref:1,$               ;reference frequency (Hz)
        ...
        amp_cor:[108.0,40.0]*1e-3,$ ;Amplitude of the correlated noise at f_ref (Jy/sqrt(Hz))
        amp_dec:[81.0,31.0]*1e-3}   ;Amplitude of the correlated noise at f_ref (Jy/sqrt(Hz))
...
day = {d14:-1,$
       ...
       ;Scan el
       ;d22:[79,82,84,86,88,90,92,94,96,98,100,102,104,106],$ 
