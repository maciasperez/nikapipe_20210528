...
source = 'Simulation - cluster diffuse 0cor'
version = 'v1'
...
rs = 1500.0                      ;Parametrisation universelle de pression (en kpc)
...
elec = {f_ref:1,$               ;reference frequency (Hz)
        ...
        amp_cor:[0.0,0.0]*1e-3,$ ;Amplitude of the correlated noise at f_ref (Jy/sqrt(Hz))
