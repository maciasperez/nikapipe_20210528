...
plot, time, data.toi[disp.ikid,*], /xs, /ys, /noerase
...
ktn_histo, 'fwhm',   pp1[2,*], junk, /noerase, k_units='(mm)', ikid=ikid, /light
ktn_histo, 'ellipt', pp1[1,*], junk, /noerase, ikid=ikid, /light
ktn_histo, 'a_peak', pp1[0,*], junk, /noerase, k_units='(Hz)', name='Peak ampl.', ikid=ikid, /light
