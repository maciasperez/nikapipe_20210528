...
source = 'Simulation - cluster diffuse'
version = 'v1'
...
P0 =80e-12                      ;Parametre de pression central (sans unite, unless M_500 is 0)
...
rs = 1500                       ;Parametrisation universelle de pression (en kpc)

caract_source = {type:type,loc:loc,z:z,M_500:M_500,P0:P0,a:a,b:b,c:c,rs:rs}

;############### Atmosphere  ###############
atmo = {tau0_a:0.12,$           ;tau at 240 GHz
...
elec = {f_ref:1,$               ;reference frequency (Hz)
        beta:-0.35,$             ;Slope of the electronic noise
        amp_cor:[108,40]*1e-3,$       ;Amplitude of the correlated noise at f_ref (Jy/sqrt(Hz))
...
day = {d14:-1,$
       ...
       ;Scan az
       ;d21:-1,$;[78,80,82,84,86,88,90,92,94,100,102,104],$
       ;d22:[78,80,81,83,85,87,89,91,93,95,97,99,101,103,105],$ 
       ;d23:[89,92,94,97,99,102,104,107,109,112,114,117],$
       ;Scan el
       ;d21:-1,$;[79,81,83,85,87,89,91,93,95,101,103,105],$
       ;d22:-1,$;[79,82,84,86,88,90,92,94,96,98,100,102,104,106],$ 
       ;d23:[90,93,95,98,100,103,105,108,110,113,115,118],$
       d24:-1,$
       d25:-1,$
       d26:-1}
