...
;
; CALLING SEQUENCE:
;         nk_write_kidpar, kidpar, out_fits_file, silent=silent
; 
; PURPOSE: 
;        Writes a kidpar into a .fits file
; 
;INPUT: 
;       kidpar, output_fits_file
;
;OUTPUT:
;     output_fits_file is written to disk.
;
;KEYWORDS:
;          - silent
; 
...
pro nk_write_kidpar, kidpar, out_fits_file, silent=silent

if n_params() lt 1 then begin
   message, /info, "Calling sequence:"
   print, "nk_write_kidpar, kidpar, out_fits_file, silent=silent"
   return
endif
