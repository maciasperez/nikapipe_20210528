...
;; pro nk_otf_geometry_sub, toi, kidpar, param, az, el, ofs_az, ofs_el
;; if not keyword_set(maps_output_dir) then maps_output_dir = !nika.plot_dir+'/Beam_maps/Maps'
pro nk_otf_geometry_sub, i_in, file_list, maps_input_dir, maps_output_dir, kidpars_output_dir, kids_out, nickname, $
