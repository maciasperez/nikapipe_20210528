...
;; Dedicated copy of nk_get_final_kidpar.pro (rev. 5943) for run10 where skydip coeffs are
;; put by hand in the kidpar

pro nk_get_final_kidpar_run10, scan, source, kidpar_in_file, kidpar_out_file, $
                               param=param, $
                               ...
                               xml=xml, keep_offsets=keep_offsets
...
;;*******************************************
;;*******************************************
;; start of RUN 10 specific section: the skydip coeffs are already in kidpar_in_file
;;*******************************************
;;*******************************************
...
;;         endif
;;      endfor
      param.do_opacity_correction = 1 ; make sure (it is sometimes forced to 1 in rta when no skydip is available yet)
      nk_get_opacity, param, info, data, kidpar
;;   endif
;;*******************************************
;;*******************************************
;; end of RUN 10 specific section
;;*******************************************
;;*******************************************
...
;; mask for optimal decorrelation
   if keyword_set(slow) then begin
      ...
      ;; Apply the preliminary calibration derived when the kids were selected in
      ;; Katana.
...
;;   wjunk = where( kidpar.type eq 1)
;;   print, "Old nas center:"
;;   print, kidpar[wjunk[0]].nas_center_x
;;   print, kidpar[wjunk[0]].nas_center_y
;;
;;   stop
   get_geometry_3, param, kidpar, ptg_numdet_ref
;;   print, "new nas center:"
;;   print, kidpar[wjunk[0]].nas_center_x
;;   print, kidpar[wjunk[0]].nas_center_y
