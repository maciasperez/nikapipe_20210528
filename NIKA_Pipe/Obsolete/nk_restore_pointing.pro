...
;
; PURPOSE: 
;        Flags approaching slew in Lissajous modes, inter subscan samples based
;        on anomalous speed, inteprolate missing pointing.
; 
; INPUT: 
...
;        - June 17th, 2014: N. Ponthieu, based on previous nk_speed_flag,
;          nk_cut_scans etc... by NP, R. Adam and L. Perotto
;-
;====================================================================================================

pro nk_restore_pointing, param, info, data, kidpar, first_subscan_beg_index, last_subscan_end_index, int_holes
...
;; Interpolate missing pointing in OTF scans and interpolates elevation, paral
;; etc... in Lissajous as well
if long(!nika.run) eq 8 or param.imbfits_ptg_restore ge 1 then begin
;;;;;   nk_otf_antenna2pointing, param, info, data, kidpar, int_holes, plot=plot
; THIS IS DONE ALREADY in nk_getdata: should not be done twice
   if param.no_otf_ptg_restore eq 0 then $
      nk_otf_pointing_restore, param, info, data, kidpar, int_holes, $
                               first_subscan_beg_index, last_subscan_end_index, $
                               plot=plot, chatty=chatty
endif
...
if param.cpu_time then nk_show_cpu_time, param, "nk_restore_pointing"
