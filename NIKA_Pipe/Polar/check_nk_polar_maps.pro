...
pro check_nk_polar_maps, param, info, data,kidpar,$
        ...
        for lambda=1, 2 do begin
           ...
           if nw1 ne 0 then begin
              ...
              for i=0, nw1-1 do begin
                 ...
                 data.toi[ikid]   = toi_t
                 data_q.toi[ikid] = toi_q
                 data_u.toi[ikid] = toi_u
                 
                
              endfor
           endif
        endfor
        ;; Subtract Q and U common modes (tested on Uranus)
        param1 = param
        param1.decor_method = 'COMMON_MODE_KIDS_OUT'
        nk_decor, param1, info, data_q, kidpar
        nk_decor, param1, info, data_u, kidpar
