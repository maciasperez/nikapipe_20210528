...
pro nk_data_conventions, param, info, data, kidpar, param_c, param_d
...
;; refered to by kidpar.array-1.
      if tag_exist( param_c, "E_F_MOD") then !nika.freqnorm1 = double( param_c.E_F_MOD) else !nika.freqnorm1 = 0.d0
      if tag_exist( param_c, "A_F_MOD") then !nika.freqnorm2 = double( param_c.A_F_MOD) else !nika.freqnorm2 = 0.d0
      if tag_exist( param_c, "M_F_MOD") then !nika.freqnorm3 = double( param_c.M_F_MOD) else !nika.freqnorm3 = 0.d0
   ...
   if nw ne 0 then begin
      if !nika.pf_ndeg gt 0 and !nika.freqnorm1 gt 0. then begin
         if strupcase(param.math) eq "PF"  then $
      ...
      return
   endelse      
   data.toi = -dapf         ;The flux is positive
endif
