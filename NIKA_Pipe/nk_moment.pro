;$Id: //depot/Release/ENVI50_IDL82/idl/idldir/lib/moment.pro#1 $
;
...
;                    NAN keyword.
;       Modified: CT, VIS, Jan 2009: Don't throw error for 1-element input,
...
;-
FUNCTION NK_Moment, X, DIMENSION=dimensionIn, $
...
;    if dimension gt 1 then begin
     if dimension ge 1 then begin
       resid = (X - REBIN(REFORM(Mean,Xdimens),fulldimens))
    endif else begin
       resid = (X - Mean)
    endelse
