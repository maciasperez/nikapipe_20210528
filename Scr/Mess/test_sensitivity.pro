...
source = 'MM18423'                                   ;Name of the source
...
output_dir = !nika.save_dir+'/'+name4file+'_lp2'
...
;;------- Launch the pipeline
nika_pipe_launch, param, map_combi, map_list,/use_noise_from_map,/make_log,/meas_atm, /check_flag_speed, /check_flag_cor, /ps, /plot_decor_toi, /map_per_kid
