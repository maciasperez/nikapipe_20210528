...
pro geom_fit_beam_parameters, nproc, maps_dir, maps_output_dir, kidpars_output_dir, nickname, input_flux_th, $
...
split_for, 0, nproc-1, $
           commands=['geom_fit_beam_parameters_sub, i, file_list, maps_dir, '+$
                     'maps_output_dir, kidpars_output_dir, kids_out, '+$
