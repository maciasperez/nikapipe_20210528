...
;; output dir
beam_maps_dir  = "/home/perotto/NIKA/Plots/N2R18/Beammaps"
...
kidpar_skydip_file = '/home/perotto/NIKA/Plots/N2R15/Opacity/kidpar_C0C1_N2R15_ref_baseline.fits'
...
;scan_list = '20180219s170'
scan_list = '20180528s107'
...
if do_second_iteration gt 0 then begin
   ...
   case 1 of
      ...
      scan_list[0] eq '20180528s107': input_kidpar_file = '/home/ladjelate/NIKA/Plots/N2R18/kidpar_'+nickname+'_v0.fits'
   ...
   make_geometry_5, scan_list, input_flux_th, ptg_numdet_ref=ptg_numdet_ref, iteration=iteration, $
                    ...
                    source=source, beam_maps_dir=beam_maps_dir, input_kidpar_file=input_kidpar_file, $
                    prepare=prepare, beams=beams, merge=merge, select=select, finalize=finalize, $
                    decor_method=decor_method, no_opacity_correction=1
