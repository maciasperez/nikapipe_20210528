...
pro geom_prepare_toi_parall, scan_list, toi_dir, maps_dir, nickname, nproc=nproc, $
                             ...
                             no_opacity_correction = no_opacity_correction, decor_cm_dmin=decor_cm_dmin, $
...
if not keyword_set(decor_cm_dmin) then decor_cm_dmin = '90.0'
if not keyword_set(mask_default_radius) then mask_default_radius = '90.0'
...
split_for, 0, nscans-1, nsplit=nsplit, $
           commands=['geom_prepare_toi_sub, i, scan_list, toi_dir, maps_dir, nickname, nproc=nproc, '+$
                     'noplot=noplot, sn_min_list=sn_min_list, sn_max_list=sn_max_list, '+$
           ...
           varnames = ['scan_list', 'toi_dir', 'maps_dir', 'nickname', 'nproc', 'noplot', 'sn_min_list', $
                       'sn_max_list', 'zigzag', 'kids_out', 'reso', 'decor_method', 'input_kidpar_file', $
                       'gamma', 'plot_dir', 'multiscans', 'no_opacity_correction', 'decor_cm_dmin', 'mask_default_radius']
