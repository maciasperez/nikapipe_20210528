...
output_fits_file = 'MonR2_nika2cov.fits'

delvarx, scan_speed
y_speed = 800. ; based on gaston speed between
mail = 0
...
case scan_model of
   ...
   1: begin
      nickname       = "MonR2_"+strtrim(scan_model,2)
      x_width        = 38*60.d0 ;40*60.d0 ; arcsec
      y_width        = 25*60.d0 ;25*60.d0 ; 60*60.d0 ; 6*60.d0  ;arcsec
      y_step         = 80.d0 ;30.d0 ;60.d0    ; arcsec
      n_subscans = round( y_width/y_step)
      angle_deg      = 45.d0
      ra_offset      = 10.d0*60.d0  ;10.d0*60.d0 ; arcsec
      dec_offset     = -2.d0*60.d0  ;1.d0*60.d0 ; arcsec
;;      scan_speed = 40.
   end

;; Model 2 : orthogonal to model 1
   2: begin
      nickname       = "MonR2_"+strtrim(scan_model,2)
      x_width        = 27*60.d0 ; arcsec
      y_width        = 39*60.d0 ;25*60.d0 ; 60*60.d0 ; 6*60.d0  ;arcsec
      y_step         = 80.d0 ;30.d0 ;60.d0    ; arcsec
      n_subscans = round( y_width/y_step)
      angle_deg      = 135.d0
      ra_offset      = 10.d0*60.d0 ; arcsec
      dec_offset     = -3.d0*60.d0 ; arcsec
;;      scan_speed = 40.
   end

;; Model 3 and 4 : smaller strategies
   3: begin
      nickname       = "MonR2_"+strtrim(scan_model,2)
      x_width        = 23*60.d0 ;40*60.d0 ; arcsec
      y_width        = 18*60.d0 ;20*60.d0 ; 60*60.d0 ; 6*60.d0  ;arcsec
      y_step         = 80.d0 ;30.d0 ;60.d0    ; arcsec
      n_subscans = round( y_width/y_step)
      angle_deg      = 90.d0        ;45.d0  ;90.d0
      ra_offset      = 13.d0*60.d0  ;10.d0*60.d0 ; arcsec
      dec_offset     = -2.d0*60.d0  ;1.d0*60.d0 ; arcsec
;;      scan_speed = 40.
   end
   
;; Model 4 : orthogonal to model 3
   4: begin
      nickname       = "MonR2_"+strtrim(scan_model,2)
      x_width        = 19*60.d0 ;21*60.d0 ; arcsec
      y_width        = 21*60.d0 ;19*60.d0 ; 60*60.d0 ; 6*60.d0  ;arcsec
      y_step         = 80.d0 ;30.d0 ;60.d0    ; arcsec
      n_subscans = round( y_width/y_step)
      angle_deg      = 0.d0        ;45.d0  ;90.d0
      ra_offset      = 13.d0*60.d0  ;10.d0*60.d0 ; arcsec
      dec_offset     = -2.d0*60.d0  ;1.d0*60.d0 ; arcsec
;;      scan_speed = 40.
   end
   ...
   5: begin
      nickname       = "MonR2_"+strtrim(scan_model,2)
      x_width        = 23*60.d0 ;40*60.d0 ; arcsec
      y_width        = 20*60.d0 ;25*60.d0 ; 60*60.d0 ; 6*60.d0  ;arcsec
      y_step         = 80.d0 ;30.d0 ;60.d0    ; arcsec
      n_subscans = round( y_width/y_step)
      angle_deg      = 45.d0        ;45.d0  ;90.d0
      ra_offset      = 14.d0*60.d0  ;10.d0*60.d0 ; arcsec
      dec_offset     = -4.d0*60.d0  ;1.d0*60.d0 ; arcsec
;;      scan_speed = 40.
   end
...
monr2 = mrdfits( !nika.pipeline_dir+"/Scr/Reference/ScanSimulator/Data/MonR2_030214.850.obs.fits", 0, header)

;; convert I map from MJy to mK
nk_get_unit_conv, scan_params
f850 = !const.c/850.d-6 *1d-9  ;GHz
f1   = !const.c/1.d-3 *1d-9    ;GHz
lambda = 850 ; microns
convert_megajy_millik, lambda, monr2, monr2_mk, /cmb_th
monr2_mk *= (f1/f850)^2 ; extrapolation a 1mm en intensite
monr2_mk *= 5/100. ; assume 5% polarization

;; back to brightness
convert_millik_megajy, lambda, monr2_mk, monr2, /cmb_th
monr2 *= 1d6 ; MegaJy to Jy/sr
monr2 *= scan_params.Beam2Sr_1mm ; Jy
monr2 *= 1000 ; mJy

wind, 1, 1, /free, /large
himview, monr2, header, imr=[-0.1,5]
;; stop
...
sigma_spec_1mm = 5./3 ; mJy
sigma_spec_2mm = 5./3 ; mJy
sigma_goal_1mm = 1.d0 ; mJy
sigma_goal_2mm = 1.d0 ; mJy
