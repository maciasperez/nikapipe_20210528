...
pro calibration_uranus_n2r9
  ...
  base_kidpar_file  = !nika.off_proc_dir+"/kidpar_best3files_FXDC0C1_GaussPhot_NewConv.fits"
  ;;C0C1_kidpar_file  = "kidpar_N2R9_lasttry_skydip.fits"
  ;;input_kidpar_file = "kidpar_best3files_GaussPhot_NewConv_C0C1inclusive.fits"
  ;;C0C1_kidpar_file  = "kidpar_N2R9_1804_v2_skydip.fits"
  ;;input_kidpar_file = "kidpar_best3files_GaussPhot_NewConv_C0C1qualfit.fits"
  C0C1_kidpar_file  = "kidpar_N2R9_nighttime_skydip.fits"
  input_kidpar_file = "kidpar_best3files_GaussPhot_NewConv_C0C1night.fits"
  skydip_coeffs, base_kidpar_file, C0C1_kidpar_file, input_kidpar_file
  ;;nickname          = 'N2R9v2'
  ...
  ;; FWHM selection cut
  fwhm_a1_max = 12.5 ;13.5; 12.5
  fwhm_a3_max = 12.5 ;13.5; 12.5
  fwhm_a2_max = 18.5
