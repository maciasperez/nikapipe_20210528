...
pro crosscheck_using_calibrators_n2r12
...
for NoTauCorrect=0, check_taucorrect do begin
   ...
   ut_tab=['00:00', '04:00', '15:00', '19:00', '20:00', '21:00', '22:00', '24:00']
   ...
   plot, fwhm[*, 0] , flux[*, 0], /xs, yr=th_flux[0]*[0.7, 1.2], $
         xr=[min(fwhm[*, 2])*0.97,min([max(fwhm[*, 2]),15.])], psym=-4, $
   ...
   plot, fwhm[*, 1] , flux[*, 1], /xs, yr=th_flux[1]*[0.7, 1.2], $
         xr=[min(fwhm[*, 1])*0.97,min([max(fwhm[*, 1]),19.])], psym=-4, $
         xtitle='FWHM (arcsec)', ytitle='Flux density (Jy/beam)', /ys, /nodata, $
         pos=pp1[0, *]
