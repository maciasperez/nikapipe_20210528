...
split_for, 0, nba-1, nsplit=nba, $
                 commands=['make_pointing_corr_n2r12_split1, i']
...
nscans = n_elements( scan)      ; should be 314
split_for, 0, nba-1, nsplit=nba, $
                 commands=['make_pointing_corr_n2r12_split2, i']
; done with PF, and no gain elevation curve
;------------------------------------------------------
...
filecsv_out = '$NIKA_SOFT_DIR/Pipeline/Datamanage/Logbook/' + $
        'Log_Iram_corr_N2R12_v1.csv'   ; This file is used in nk_get_kidpar_ref
...
; Done 11/4/2018 for
; kidpar_20171025s41_v2_LP_skd_kids_out.fits
