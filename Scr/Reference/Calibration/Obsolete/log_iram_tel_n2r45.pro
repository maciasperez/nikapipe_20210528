...
pro log_iram_tel_n2r45
  
spawn, "ls "+!nika.imb_fits_dir+"/*202010*imb.fits", imb_fits_list
spawn, "ls "+!nika.imb_fits_dir+"/*202011*imb.fits", imb_fits_list_1
imb_fits_list = [imb_fits_list, imb_fits_list_1]
...
w = where( long(day_list) ge 20201020 and long(day_list) le 20201103, nw)
...
nonika = 1
run_logfile_save = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_N2R45_v0.save"
run_logfile_csv  = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_N2R45_v0.csv"
...
param_file_list = 'log_iram_tel_N2R45_param_'+strtrim( indgen(nproc),2)+'.save'
