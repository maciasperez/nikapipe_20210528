...
pro baseline_calibration_tau225
  ...
  opacity_from_tau225   = 1

  ;; original ATM model
  modified_atm_tau225_ratio = [0., 0., 0.]
  
  ;; modified ATM : alpha_1, alpha_2, alpha_3
  filename = !nika.pipeline_dir+'/Datamanage/Tau225/modified_ATM_tau225_ratios.save'
  ;;modified_atm_tau225_ratio = [0.55, 0.4, 0.5]
  ;;modified_atm_tau225_ratio = [1.25, 1.05, 1.25]
  ;;modified_atm_tau225_ratio = [1.05, 1.05, 1.05]
  ;;modified_atm_tau225_ratio = [1.7, 1.05, 1.7]
  ;modified_atm_tau225_ratio = [1.2, 1., 1.2]
  ;;modified_atm_tau225_ratio = [1.2, 1., 1.2]
...
;; parameter copy here
        ...
        ;; absolute calibration using  using no photometric correction
