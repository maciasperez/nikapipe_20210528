...
pro log_iram_tel_n2r21
  
spawn, "ls "+!nika.imb_fits_dir+"/*201809*imb.fits", imb_fits_list

nonika = 1
run_logfile_save = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_N2R21_v0.save"
run_logfile_csv  = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_N2R21_v0.csv"
...
param_file_list = 'log_iram_tel_N2R21_param_'+strtrim( indgen(nproc),2)+'.save'
...
for iproc=0, nproc-1 do begin
   ...
   endelse
   logfile_save = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_N2R21_v0_sub"+strtrim(iproc,2)+".save"
   logfile_csv  = !nika.pipeline_dir+"/Datamanage/Logbook/Log_Iram_tel_N2R21_v0_sub"+strtrim(iproc,2)+".csv"
...
exitmail, message='log_iram_tel_n2r21 v3 done on '+!host
