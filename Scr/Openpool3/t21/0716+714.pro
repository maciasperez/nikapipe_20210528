;-------------------
;; Check the template script that combines maps in real time
;;========================================================================

;; Find a smart way to derive the list of scans
source = '0716+714'
obstype = 'onTheFlyMap'  ; could be Lissajous too Insensitive to case
imrange_1mm = [-0.1,1]*1    ; Guess the range in Jy/Beam
imrange_2mm = [-0.1,1]*1
...
scan_list = scan[indscan].day + 's' + strtrim( scan[indscan].scannum,2)
...
nk_default_mask, param, info, grid, d = 20
