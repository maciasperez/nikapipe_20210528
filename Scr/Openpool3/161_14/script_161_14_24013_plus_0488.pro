pro script_161_14_24013_plus_0488, nscans=nscans, list_results_only=list_results_only, keep_current_result=keep_current_result, $
subtract_maps=subtract_maps, preproc=preproc, average=average, reset=reset
if keyword_set(average) then begin
rfile = !nika.plot_dir+'/running_161_14_24013_plus_0488.dat'
...
nscans = 0 ; init
restore, db_file
w = where( strupcase( strtrim(scan.object,2))  eq strupcase('24013+0488') and $
...
if nw eq 0 then begin
   message, /info, 'No scan observing 24013+0488 was found in '+db_file
   goto, exit
endif
...
param.source        = '24013+0488'
param.silent            = 1
param.map_reso          = 2.d0 ; arcsec
param.name4file = '24013+0488'
