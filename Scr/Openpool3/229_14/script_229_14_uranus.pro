pro script_229_14_uranus, nscans=nscans
...
nscans = 0 ; init
restore, db_file
w = where( strupcase( strtrim(scan.object,2))  eq strupcase('URANUS') and $
...
if nw eq 0 then begin
   message, /info, 'No scan observing URANUS was found in '+db_file
   goto, exit
endif
