...
pro kid_selection_2, scan_list, maps_output_dir, kidpars_output_dir, nickname, $
...
spawn, "ls "+maps_output_dir+"/map_list*"+nickname+"*.save",  map_list
...
cmd = "mv kidpar_"+strtrim(scan,2)+"_test_"+strtrim(preproc_index,2)+".fits "+$
      "kidpar_select_"+strtrim(scan,2)+".fits"
print, "Wrote kidpar_select_"+strtrim(scan,2)+".fits"
spawn, cmd
